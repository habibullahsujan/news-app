...
const SignUp = () => {
  const { createUser, user, emailVerification } = useContext(AuthContext);
    ...
    <div className="flex justify-center mt-3">
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 bg-slate-400">
        ...
        >
          ...
          disabled={!accept}
            type="submit  "
            className=" border border-white block w-full p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400"
          >
            Sign Up
          </button>
        </form>
